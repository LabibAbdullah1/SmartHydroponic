...
<div align="center">
  ...
  <img src="public/images/mobile-view-riwayat.png" 
       ...
       width="45%" 
       style="border-radius: 15px; margin-left: 5px;">
  <br>
  <br>
...
6. **Cara Menjalankan Project**
   ...
   - Cara manual
    ...
    -  **Dengan Alat (ESP32):** Klik 2x `scripts/win-start-project.bat`.
        * *Menjalankan: Server & MQTT Subscribe saja.*

    #### 🍎 Pengguna MacOS
    -  **Tanpa Alat (Simulasi):** Klik 2x `scripts/mac-start-testing.command`.
